...
export default function CobranzaPage() {
  ...
  /* ── WhatsApp helper ── */
  function buildWhatsAppUrl(c: ClienteCobranzaGroup): string {
                      ...
                      <div className="inline-flex items-center gap-2">
                        {c.telefono && (
                          <a
                            ...
                            className="inline-flex items-center justify-center w-9 h-9 rounded-xl border border-[#25D366]/40 bg-[#25D366]/15 text-[#25D366] hover:bg-[#25D366]/28 hover:border-[#25D366]/60 transition-all duration-150 active:scale-95"
                          >
